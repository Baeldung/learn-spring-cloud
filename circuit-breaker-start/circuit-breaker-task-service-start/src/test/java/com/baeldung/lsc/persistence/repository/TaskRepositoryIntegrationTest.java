...
public class TaskRepositoryIntegrationTest {
    ...
    public void givenNewTask_whenSaved_thenSuccess() {
        Campaign newCampaign =
            campaignRepository.save(new Campaign("CTEST-3", "Test Campaign 3", "Description for campaign CTEST-3"));
    ...
    public void givenTaskCreated_whenFindById_thenSuccess() {
        Campaign newCampaign =
            campaignRepository.save(new Campaign("CTEST-4", "Test Campaign 4", "Description for campaign CTEST-4"));
